...
<div <?php if($id): ?> id="<?php echo e($id); ?>" <?php endif; ?> class="<?php echo \Illuminate\Support\Arr::toCssClasses(['modal fade', $class => $class]) ?>" tabindex="-1" role="dialog" aria-labelledby="<?php echo e($id); ?>"
    ...
    <div class="<?php echo \Illuminate\Support\Arr::toCssClasses(['modal-dialog', 'modal-xs' => ! $size && strlen($slot) < 120, 'modal-lg' => ! $size && strlen($slot) > 1000, 'modal-' . str_replace('modal-', '', (string)$size) => $size]) ?>">
...
<?php /**PATH /var/www/admin/platform/core/base/resources/views/components/modal.blade.php ENDPATH**/ ?>