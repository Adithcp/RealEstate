<li class="relative md:flex md:flex-1">
            <span class="flex items-center px-6 py-4 text-sm font-medium">
                    ...
                    <span class="ms-4 text-sm font-medium text-indigo-600"><?php echo e(trans('packages/installer::installer.final.title')); ?></span>
                ...
                <?php else: ?>
                    ...
                    <span class="ms-4 text-sm font-medium text-gray-900"><?php echo e(trans('packages/installer::installer.final.title')); ?></span>
                <?php endif; ?>
            </span>
</li>
<?php /**PATH /var/www/admin/platform/packages/installer/resources/views/partials/step-5.blade.php ENDPATH**/ ?>