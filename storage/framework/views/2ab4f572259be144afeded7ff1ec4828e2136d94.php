<nav id="admin_bar">
    <div class="admin-bar-container">
        <div class="admin-bar-logo">
            <a href="<?php echo e(route('dashboard.index')); ?>" title="<?php echo e(trans('packages/theme::theme.go_to_dashboard')); ?>">
                <img src="<?php echo e(setting('admin_logo') ? RvMedia::getImageUrl(setting('admin_logo')) : url(config('core.base.general.logo'))); ?>" alt="logo"/>
            </a>
        </div>
            ...
            <?php $__currentLoopData = AdminBar::getGroups(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slug => $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($items = Arr::get($group, 'items', [])): ?>
                    ...
                    <li class="admin-bar-dropdown">
                        <a href="<?php echo e(Arr::get($group, 'link')); ?>" class="dropdown-toggle">
                            <?php echo e(Arr::get($group, 'title')); ?>

                        </a>
                        <ul class="admin-bar-dropdown-menu">
                            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(Arr::get($item, 'permission') && !Auth::user()->hasPermission($item['permission'])) continue; ?>
                                <li>
        ...
        <ul class="admin-navbar-nav admin-navbar-nav-right">
            <li class="admin-bar-dropdown">
                <a href="<?php echo e(route('users.profile.view', ['id' => Auth::id()])); ?>" class="dropdown-toggle">
                    <?php echo e(Auth::user()->name); ?>

                </a>
                <ul class="admin-bar-dropdown-menu">
                    <li><a href="<?php echo e(route('users.profile.view', Auth::id())); ?>"><?php echo e(trans('core/base::layouts.profile')); ?></a></li>
...
<?php /**PATH /var/www/admin/platform/packages/theme/resources/views/admin-bar.blade.php ENDPATH**/ ?>