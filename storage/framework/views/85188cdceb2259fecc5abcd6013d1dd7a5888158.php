...
<?php switch($style):
    case (1): ?>
        <section class="relative mt-20">
            <div class="mx-2 container-fluid md:mx-4">
                <div class="relative table w-full pt-40 overflow-hidden shadow-md pb-52 rounded-2xl" id="home" data-images="<?php echo e(json_encode($images)); ?>">
                    <div class="absolute inset-0 bg-black/60"></div>
                    <div class="container">
                        <div class="grid grid-cols-1">
                            <div class="text-center md:text-start">
                                <h1 class="mb-6 text-4xl font-bold leading-normal text-white lg:leading-normal lg:text-5xl">
                                    <?php echo BaseHelper::clean(str_replace($shortcode->title_highlight, "<span class='text-primary'>$shortcode->title_highlight</span>", $shortcode->title)); ?>

                                </h1>
                                <?php if($subtitle = $shortcode->subtitle): ?>
                                    <p class="max-w-xl text-xl text-white/70"><?php echo BaseHelper::clean($subtitle); ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
        ...
        <?php if($shortcode->enabled_search_box): ?>
            <div class="container relative">
                <div class="grid justify-center grid-cols-1">
                    <div class="relative -mt-32">
                        <?php echo Theme::partial('search-box', compact('categories', 'style', 'shortcode')); ?>
    ...
    <?php case (2): ?>
        <section class="relative table w-full overflow-hidden py-36 lg:py-44 zoom-image">
            <div class="absolute inset-0 image-wrap z-1" id="home" data-images="<?php echo e(json_encode($images)); ?>"></div>
            ...
            <div class="container z-3">
                <div class="grid grid-cols-1 mt-10">
                    <div class="text-center">
                        ...
                        <?php if($subtitle = $shortcode->subtitle): ?>
                            <p class="max-w-xl mx-auto text-xl text-white/70"><?php echo BaseHelper::clean($subtitle); ?></p>
                        <?php endif; ?>
                    </div>
            ...
            <div class="container">
                <div class="grid md:grid-cols-2 gap-[30px] mt-10 items-center">
                    <div class="text-center md:text-start">
                        ...
                        <?php if($subtitle = $shortcode->subtitle): ?>
                            <p class="max-w-xl text-xl text-slate-400"><?php echo BaseHelper::clean($subtitle); ?></p>
                        <?php endif; ?>
                    ...
                    <div class="relative lg:ms-10">
                        <?php if($images[0]): ?>
                            <div class="p-5 bg-white rounded-t-full shadow dark:shadow-gray-700 dark:bg-slate-900">
                                <img src="<?php echo e(RvMedia::getImageUrl($images[0], false, RvMedia::getDefaultImage())); ?>" class="rounded-md rounded-t-full shadow-md" alt="<?php echo e($shortcode->title); ?>">
                            </div>
                        <?php endif; ?>
                        <div class="absolute start-0 end-0 text-center bottom-2/4 translate-y-2/4">
                            <a href="#" data-type="youtube" data-id="<?php echo e($shortcode->youtube_video_id); ?>" data-group="hero-banner-youtube-video-<?php echo e($shortcode->youtube_video_id); ?>" class="inline-flex items-center justify-center w-20 h-20 bg-white rounded-full shadow-md lightbox dark:shadow-gray-800 dark:bg-slate-900 text-primary">
    ...
    <?php default: ?>
        ...
        <section class="relative table w-full py-32 bg-center bg-no-repeat lg:py-36" id="home" data-images="<?php echo e(json_encode([$background])); ?>">
            ...
            <div class="container">
                <div class="grid grid-cols-1 mt-10 text-center">
                    ...
                    <?php if($subtitle = $shortcode->subtitle): ?>
                        <p class="max-w-3xl mx-auto mt-5 text-xl text-white/70"><?php echo BaseHelper::clean($subtitle); ?></p>
                    <?php endif; ?>
                </div>
            </div>
        </section>
        ...
        <?php if($shortcode->enabled_search_box): ?>
            ...
            <div class="fixed top-0 start-0 w-10/12 h-screen transition-transform duration-300 -translate-x-full md:hidden z-999 dark:bg-gray-800" id="filter-drawer">
                <div class="absolute inset-0 w-full h-full p-4 overflow-y-auto bg-white dark:bg-slate-900">
                    ...
                    <div class="mt-8 mb-12 <?php echo e($searchType === 'projects' ? 'project' : 'property'); ?>-search item-search">
                        <?php echo Theme::partial("real-estate.$searchType.search-box", ['id' => 'mobile', 'type' => 'rent', 'categories' => $categories]); ?>
            ...
            <div class="container relative hidden -mt-16 md:block z-1 item-search">
                <div class="grid grid-cols-1">
                    <div class="p-6 bg-white shadow-md dark:bg-slate-900 rounded-xl dark:shadow-gray-700">
                        <?php echo Theme::partial("real-estate.$searchType.search-box", ['id' => null, 'type' => 'rent', 'categories' => $categories]); ?>
        ...
        <?php break; ?>
<?php endswitch; ?>
<?php /**PATH /var/www/admin/platform/themes/hously/partials/shortcodes/hero-banner/index.blade.php ENDPATH**/ ?>